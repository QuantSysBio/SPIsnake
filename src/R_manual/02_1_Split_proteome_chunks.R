...
library(parallelly)
library(foreach)
source("/home/yhorokh/Snakemake/SPI-snake_dev/src/snakefiles/functions.R")

### ---------------------------- (1) Read input file and extract info ----------------------------
# database
# proteome <- as.character("/home/yhorokh/Snakemake/SPI-snake_dev/data/reference/proteome_expressed_gencode.fasta")
proteome <- as.character("/home/yhorokh/Snakemake/SPI-snake_dev/data/reference/fiveUTR_seq_3_frame.fasta")
...
# Clustering
prot_cluster <- read.table("/home/yhorokh/Snakemake/SPI-snake_dev/results/Cluster/fiveUTR_seq_3_frame/fiveUTR_seq_3_frame_cluster.tsv")
# prot_cluster <- read.table("/home/yhorokh/Snakemake/SPI-snake_dev/results/Cluster/proteome_expressed_gencode/proteome_expressed_gencode_cluster.tsv")
